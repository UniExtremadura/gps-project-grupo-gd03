...
class OrderPlaylistTracksByPopularityTest {
    ...
    @Test
    fun orderPlaylistTracksByPopularityTest() {
        ...
        val materialRadioButton = onView(
            allOf(
                withId(R.id.playlistDetailsRadioButton2), withText("Filter by popularity"),
                childAtPosition(
                    allOf(
                        withId(R.id.playlistDetailsRadioGroup),
                        childAtPosition(
                            withClassName(`is`("android.widget.LinearLayout")),
                            3
                        )
