...
class FilterPlaylistTracksByArtistTest {
    ...
    @Test
    fun filterPlaylistTracksByArtistTest() {
        ...
        appCompatEditText1.perform(replaceText("My playlist"), closeSoftKeyboard())
        ...
        val appCompatEditText2 = onView(
            allOf(
                withId(R.id.playlistDetailsEditText),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("android.widget.FrameLayout")),
                        0
        ...
        appCompatEditText2.perform(replaceText("Axwell"), closeSoftKeyboard())
